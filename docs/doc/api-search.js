$(function() {
  var index = [
    ...
    {label: "cli4clj.cli/alt-scroll-writer", value: "cli4clj.cli.html#IDalt-scroll-writer"},
    ...
    {label: "cli4clj.cli/get-writer-to-wrap", value: "cli4clj.cli.html#IDget-writer-to-wrap"},
    ...
    {label: "cli4clj.cli/set-up-alternate-scrolling", value: "cli4clj.cli.html#IDset-up-alternate-scrolling"},
    {label: "cli4clj.cli/skip-whitespace", value: "cli4clj.cli.html#IDskip-whitespace"},
    {label: "cli4clj.cli/start-cli", value: "cli4clj.cli.html#IDstart-cli"},
    {label: "cli4clj.cli/windows-workaround", value: "cli4clj.cli.html#IDwindows-workaround"},
    {label: "cli4clj.cli/with-alt-scroll-out", value: "cli4clj.cli.html#IDwith-alt-scroll-out"},
    {label: "cli4clj.cli/wrap-alt-scroll-writer", value: "cli4clj.cli.html#IDwrap-alt-scroll-writer"},
